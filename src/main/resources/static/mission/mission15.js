...
let map15 = getDefaultMap('map15', getOSMLayer(), get3857View());
...
function addInteraction() {
    ...
    draw.on('drawend', function () {
        ...
        map15.once('pointermove', function () {
            modifyStyle.setGeometry();
        });
        tip = idleTip;
    });
    modify.setActive(true);
    map15.addInteraction(draw);
}

typeSelect.onchange = function () {
    map15.removeInteraction(draw);
    addInteraction();
};
...
function loadMap15() {
    map15.addLayer(new ol.layer.Vector({
        source: source,
        style: function (feature) {
            return styleFunction(feature, showSegments.checked);
        },
    ...
    map15.addLayer(vector);

    map15.addInteraction(modify);
